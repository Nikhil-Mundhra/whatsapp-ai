export function DoubleCheckIcon({ className = "", isRead = true, size = 16 }) {
  return (
    <svg
      viewBox="0 0 16 11"
      width={size}
    ...
    >
      <path
        d="M11.05 1.25L4.85 7.45L2.15 4.75L1.25 5.65L4.85 9.25L11.95 2.15L11.05 1.25Z"
        fill={isRead ? "#53bdeb" : "#8696a0"}
      />
      <path
        d="M14.75 1.25L8.55 7.45L7.25 6.15L6.35 7.05L8.55 9.25L15.65 2.15L14.75 1.25Z"
        fill={isRead ? "#53bdeb" : "#8696a0"}
      />
    </svg>
  );
...
export function SearchIcon({ size = 18, color = "#54656f" }) {
  return (
...
export function SettingsIcon({ size = 20, color = "#54656f" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RefreshIcon({ size = 18, color = "#54656f" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function AttachIcon({ size = 20, color = "#54656f" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SmileIcon({ size = 22, color = "#54656f" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RobotIcon({ size = 16, color = "#075e54" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function PollIcon({ size = 18, color = "#00a884" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LockIcon({ size = 14, color = "#8696a0" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CloseIcon({ size = 20, color = "#ffffff" }) {
  return (
...
export function MoreVertIcon({ size = 20, color = "#54656f" }) {
  return (
...
export function WarningIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CheckIcon({ size = 16, color = "currentColor", strokeWidth = 2.5 }) {
  return (
...
export function KeyIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 2l-2 2m-1.5 1.5L14 9a5 5 0 1 0-7 7 5 5 0 0 0 7-7l3.5-3.5 2-2z"></path>
    </svg>
  );
}
...
export function WatchIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function MonitorIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ZapIcon({ size = 15, color = "currentColor" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ArrowLeftIcon({ size = 15, color = "currentColor" }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke={color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
